...
<div id="container">
    ...
    <div id="content">
        <div id="content_left">
            ...
            <img src="assets/img/emotionsent-bgr.png"  class="image_choose" />

            <img src='<?php echo "assets/img/".$select."-big.png"; ?>' class="img_love_emo" />

            <span class="text_emo1 text_white" >Emotion </span><br/>
            <span class="text_emo3 text_white" >Sent!</span>

            <span class="text_emo2 text_white">Send Back a photo!</span>
        ...
        <div id="content_right">
            <div class="text_right">
                <br/>
                <span class="text_white text_timeup3" style="margin-left: 70px;" >Oh! Time Is Up!</span><br/>
...
<div id="medium">
    ...
    <div id="m_content">
        <div class="m_timeup_text">
            <span class="m_text1_1 text_white">Oh, Time is Up!</span><br/>
        ...
        <div class="m_text_timeup_2 font_open text_white">
            ...
            <span class="m_text_timeup_2_1">experience to share your speical moments</span><br/>
        ...
        <div class="m_image_timeup">
            <div class="m_image_timeup1">
                <span class="m_image_timeup1_text1 font_amatic">Emotion</span>
                <span class="m_image_timeup1_text2  font_amatic"> Sent!</span>
                <span class="m_image_timeup1_text3 font_cover text_white" >Send Back a Photo!</span>
                <img src='<?php echo "assets/img/".$select."-big.png"; ?>' class="m_image_timeup1_emo" />
                <img src="assets/img/emotionsent-bgr.png" alt="" class="m_image_timeup11" />
