...
if($detect->isAndroidOS()){
    if($lang== "vi"){
        header("Location:https://play.google.com/store/apps/details?id=is.cinnamon.picchat&hl=vi");
    }
    else if($lang== "ja"){
        header("Location:https://play.google.com/store/apps/details?id=is.cinnamon.picchat&hl=Ja");
    }
    else if($lang == "th"){
        header("Location:https://play.google.com/store/apps/details?id=is.cinnamon.picchat&hl=Th");
    }
    else if($lang == "zh"){
        header("Location:https://play.google.com/store/apps/details?id=is.cinnamon.picchat&hl=Zh");
    }
    else {
        header("Location:https://play.google.com/store/apps/details?id=is.cinnamon.picchat&hl=en");
    }
}
else if($detect->isiOS()){
    header("Location:https://itunes.apple.com/au/app/picchat-visual-chat/id796843586");
}
else{
    header("Location:http://picchat.co");
}
?>
